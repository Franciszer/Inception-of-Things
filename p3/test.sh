#!/bin/bash
# Checks every point from the P3 correction sheet:
#   1. K3d cluster is running
#   2. The 2 required namespaces exist (argocd, dev)
...
# 2 — namespaces (subject requires both)
